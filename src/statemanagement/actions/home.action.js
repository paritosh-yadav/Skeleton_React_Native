...
const initiateBreweriesFetching = (): GetBreweriesInitiatedAction => ({
...
const breweriesFetchingSucceed = (data: Object): GetBreweriesSuccessAction => ({
    //When action succeed
    type: GET_BREWERIES_SUCCEED,
    payload: {
        data,
...
const breweriesFetchingFailed = (error: Object): GetBreweriesFailedAction => ({
    //When action failed
...
type Dispatch = (
    action:
        ...
        | ThunkAction
        | PromiseAction
        | Array<HomerActionsType>,
) => any;
type ThunkAction = (dispatch: Dispatch) => any;

export const fetchingBreweries = (
    endpoint: string,
    params: Object,
    payload: Object,
): ThunkAction => {
    return function (dispatch) {
        ...
        return api.initiateAPICall(endpoint, 'get', params, payload).then(
            // API call initiated
